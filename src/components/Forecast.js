        ...
        return (
          <div className="flex items-center justify-between">
            ...
            <div className="w-full flex items-center gap-4">
              <h3 className="text-xl font-semibold">{(val?.main?.temp_min - 273.15).toFixed(1)}&deg;c</h3>
              <hr className="border-base-content border-2 w-full" />

              <h3 className="text-xl font-semibold">{(val?.main?.temp_max - 273.15).toFixed(1)}&deg;c</h3>
            </div>
          </div>
        );
      })}
